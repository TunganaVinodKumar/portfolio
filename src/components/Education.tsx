    ...
    >
      <div className="section-shell">
        <SectionHeading
          ...
          subtitle="Engineering and scientific foundation in Computer Science, Artificial Intelligence, Machine Learning, and Mathematics."
        />
                    ...
                    <div>
                      ...
                      {item.specialization && (
                        <div className="mt-2.5 inline-flex items-center gap-1.5 rounded-md bg-blue-50 border border-blue-200 px-3 py-1 text-xs font-semibold text-[#4361ee]">
                          ...
                          <span>{item.badgeText || item.specialization}</span>
                        </div>
                      )}
                    </div>
                  </div>
